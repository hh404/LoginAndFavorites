...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    [UserManager requestAppOauthStatus:[ShareDataManager shareManager].currentUserInfo.userName success:^(HTTPBaseResponse *response) {
